const translations = {
    ...
    ar: {
        ...
        aboutTitle: "حول",
        aboutDesc: "ClinicalMind هي منصة ذكاء طبي ثورية مدعومة بالذكاء الاصطناعي، مصممة لمساعدة المتخصصين في الرعاية الصحية على التشخيص الدقيق. يجمع نظامنا بين خوارزميات التعلم الآلي المتقدمة والخبرة الطبية لتقديم تحليل موثوق للصور الطبية وأعراض المرضى.",
